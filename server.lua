QBCore = exports['qb-core']:GetCoreObject()
 ...
 AddEventHandler('moneywash:server:StartMoneyWash', function()
     ...
     local endTime = os.time() + Config.WashTime / 1000
     ...
     if markedBills ~= nil and markedBills.amount > 0 then
         ...
         if Player.Functions.RemoveItem(Config.ItemRequired, amount) then
             ...
             TriggerClientEvent('QBCore:Notify', src, 'Money washing started. Come back in 30 minutes to collect your cash.', 'success')
 
               exports.oxmysql:execute('INSERT INTO money_wash (citizenid, marked_bills, cash_amount, end_time) VALUES (@citizenid, @marked_bills, @cash_amount, @end_time)', {
                 ['@citizenid'] = citizenId,
                 ['@marked_bills'] = amount,
 ...
 Citizen.CreateThread(function()
     while true do
         ...
         exports.oxmysql:execute('SELECT * FROM money_wash WHERE end_time <= @current_time', {
